...
media = {'file': open('dogs_of_the_dax_charttwitterupdate.jpg','rb')} # 'picture.jpg' path to the image, we load it as a binary file
...
postid2 =json.loads(image.content.decode('utf-8'))['id'] # get the post-id of the image out of the response (we will use it further down to change the wp-image parameters)
print('Chart-Bild bei: {} veröffentlicht. ID: {}'.format(link, postid2))